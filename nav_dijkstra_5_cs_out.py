...
def rotate(rot,bot_euler,rot_dir): 
	...
	twist.linear.x=0.0
	if rot=="north":
		twist.angular.z= rot_dir*(0.01 +abs((bot_euler)-pi/2)*0.3)
	elif rot=="south":
		twist.angular.z= rot_dir*(0.01+ (abs((bot_euler)+(pi/2)))*0.3)
	elif rot=="east":
		twist.angular.z= rot_dir*(0.01+ (abs(bot_euler))*0.3)
	elif rot=="west":
		twist.angular.z=rot_dir*(0.01+(abs(abs(bot_euler)-pi))*0.3)
	pub.publish(twist)
#	rospy.sleep(0.2)
#	twist.angular.z=0.0
#	pub.publish(twist)
